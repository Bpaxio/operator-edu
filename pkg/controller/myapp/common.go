...
func (r *ReconcileMyApp) ensureDeployment(request reconcile.Request,
...
func (r *ReconcileMyApp) ensureService(request reconcile.Request,
	instance *bpaxiov1.MyApp,
	s *corev1.Service,
) (*reconcile.Result, error) {
...
func (r *ReconcileMyApp) ensureSecret(request reconcile.Request,
	instance *bpaxiov1.MyApp,
	s *corev1.Secret,
) (*reconcile.Result, error) {
	found := &corev1.Secret{}
...
func labels(cr *bpaxiov1.MyApp, tier string) map[string]string {
	return map[string]string{
		"app":             "myapp",
		"visitorssite_cr": cr.Name,
		"tier":            tier,
	}
}
